...
from monstim_utils import format_report, get_output_path, get_data_path
...
class EMGAnalysisGUI(QMainWindow):
    ...
    def create_plot_widgets(self):
        ...
        # EMG data type selection
        self.emg_data_type_label = QLabel("Select EMG Data Type:")
        self.emg_data_type_combo = QComboBox()
        self.emg_data_type_combo.addItems(["filtered", "raw", "rectified_raw", "rectified_filtered"])
        layout.addWidget(self.emg_data_type_label)
        layout.addWidget(self.emg_data_type_combo)
    ...
    def plot_data(self):
        ...
        if plot_type_raw == "EMG":
            data_type = self.emg_data_type_combo.currentText()
