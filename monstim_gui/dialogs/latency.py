...
class LatencyWindowsDialog(QDialog):
    ...
    def _add_window_group(self, window: LatencyWindow | None = None):
        ...
        self.window_entries.append((group, window, name_edit, global_start_spin, dur_spin, color_combo, global_radio, per_channel_spins))
    ...
    def save_windows(self):
        new_windows = []
        num_channels = len(self.data.channel_names)
        for group, window, name_edit, global_start_spin, dur_spin, color_combo, global_radio, per_channel_spins in self.window_entries:
