...
from PyQt6.QtWidgets import (QDialog, QVBoxLayout, QFormLayout, QGroupBox, 
                            QCheckBox, QPushButton, QHBoxLayout, QLabel, QMessageBox)
...
class ProgramPreferencesDialog(QDialog):
    ...
    def save_preferences(self):
        ...
        self.app_state.set_preference(
            "track_session_restoration", 
            self.session_tracking_checkbox.isChecked()
        )
        self.app_state.set_preference(
            "track_analysis_profiles", 
            self.profile_tracking_checkbox.isChecked()
        )
        self.app_state.set_preference(
            "track_import_export_paths", 
            self.path_tracking_checkbox.isChecked()
        )
        self.app_state.set_preference(
            "track_recent_files", 
            self.recent_files_checkbox.isChecked()
        )
