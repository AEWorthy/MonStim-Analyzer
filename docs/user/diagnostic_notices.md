...
The selection pane shows one symbol beside the selected experiment, dataset, or session when it has notices. The symbol summarizes the highest severity present; open its tooltip to read every notice and its details.

| Symbol  | Meaning                                                                                                                                                                       | What to do                                                                                        |
| ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| &#9888; | **Warning.** At least one notice could prevent a valid analysis or materially affect it. Warnings take precedence when warnings and information notices occur together. | Review and resolve the affected condition before making a final plot or export whenever possible. |
| &#8505; | **Information.** The selected item has useful review information but no warnings.                                                                                       | Read the tooltip and confirm that the condition is expected for the analysis.                     |
