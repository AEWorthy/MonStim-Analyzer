...
![The latency-window editor shows the active synthetic session, the selected Session scope, two named windows, and editable M-wave parameters before Apply is used.](../assets/demo/latency-windows.png)
